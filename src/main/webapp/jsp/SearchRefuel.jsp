...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="content">
            <!-- 右侧内容框架，更改从这里开始 -->
            <form class="layui-form xbs" action=""  name="RefuelItem">
                <div class="layui-form-pane" style="text-align: center;">
                    <div class="layui-form-item" style="display: inline-block;">
                        ...
                        <%--<div class="layui-input-inline" style="width:80px">--%>
                            <%--<input class="layui-btn"  name="SearchRefuel" onclick="SearchRefuel()">--%>
                        <%--</div>--%>
                    </div>
                </div>
            </form>
            <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button><button class="layui-btn" onclick="member_add('添加车辆信息','/jsp/addRefuel.jsp','600','500')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：${requestScope.refuels.size()}条</span></xblock>
...
<script>
    ...
    function SearchRefuel() {
        var RefuelItems=new Array();
        $("#input[name='RefuelItem']:checkbox:checked").each(function (index,element) {
            RefuelItems[index]=$(element).val();
        })
        $.post("/SearchRefuel",{RefuelItems:JSON.stringify(RefuelItems)},function (data) {
            if(data.toString()=="success"){
                $("input[name='RefuelItem']:checkbox:checked").each(function (index,element) {
                    $(element).parents("tr").select();
                });
            }else {
