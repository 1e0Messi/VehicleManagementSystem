...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="content">
            <!-- 右侧内容框架，更改从这里开始 -->
            <form  action="/updateFee" class="layui-form">
                <div class="layui-form-item">
                    <label for="feeid" class="layui-form-label">
                        <span class="x-red">*</span>费用编号
                    </label>
                    <div class="layui-input-inline">
                        <input type="text" id="feeid" name="feeid" required="" lay-verify="required" value="${param.feeid}"
            ...
            <pre style="text-align: center;color: #FF0000">更新数据成功!</pre>
            <!-- 右侧内容框架，更改从这里结束 -->
        </div>
    </div>
    <!-- 右侧主体结束 -->
