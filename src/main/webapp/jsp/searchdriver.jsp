...
">
    ...
    <div class="page-content">
        <div class="content">
            <!-- 右侧内容框架，更改从这里开始 -->
            <form class="layui-form xbs" action="/selectdriver" method="post">
                <div class="layui-form-pane" style="text-align: center;">
                    <div class="layui-form-item" style="display: inline-block;">
                        <div class="layui-input-inline xbs768">
                            <input class="layui-input" placeholder="驾驶员ID" name="staff_ID">
                        </div>
                        <div class="layui-input-inline xbs768">
                            <input class="layui-input" placeholder="驾驶员姓名" name="staff_name">
                        </div>
                        <div class="layui-input-inline xbs768">
                            <input name="ID_card"  placeholder="身份证" class="layui-input">
                        </div>
            ...
            <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button>
                <button class="layui-btn" onclick="member_add('添加驾驶员','/adddriverjsp','590','650')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px" id="recording">共有记录：${requestScope.driver.size()}条</span></xblock>
                ...
                <c:forEach items="${requestScope.driver}" var="T">
                    <tr>
                        ...
                        <td class="td-manage">
                            ...
                            <a title="删除" onclick="member_del(this,${T.staff_ID})"
...
<script>
    ...
    /*用户-删除*/
    function member_del(obj,staff_ID){
        layer.confirm('确认要删除吗？',function(index){
            //发异步删除数据
            $.post("/deldriversearch",{staff_ID:staff_ID},function (data) {
